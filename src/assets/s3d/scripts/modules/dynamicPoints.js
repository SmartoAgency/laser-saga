...
export default class DynamicPoints {
  ...
  create() {
    ...
    const { mesh, meshConfig } = createMesh(positions, 1, 0, 10, 0, 0xffddff);
    this.mesh = mesh;
    ...
    const effectFilm = new FilmPass(0.1, 1, 724, false);
...
//     createMesh(positions, 1, -300, 10, 0, 0xffdd44);
//     // createMesh(positions, scene, 4.05, 0, -350, 0, 0xffffff);
//
//     const grid = new THREE.Points(new THREE.PlaneGeometry(15000, 15000, 64, 64), new THREE.PointsMaterial({
//       color: 0xff0000,
